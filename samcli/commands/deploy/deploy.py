...
class DeployCommand(object):
    ...
    ARG_TABLE = [
        ...
        },
        {
            ...
            'help_text': (
                ...
                'templates sized greatebr than 51,200 bytes'
            )
        },
        {
            "name": "force-upload",
    ...
    def _run_main(self, template_file, stack_name, s3_bucket, force_upload, s3_prefix, kms_key_id, parameter_overrides, capabilities, execute_changeset, role_arn, notification_arns, fail_on_empty_changeset, tags, region, profile):
        ...
        tags_dict = self.parse_key_value_arg(tags, self.TAGS_CMD)
